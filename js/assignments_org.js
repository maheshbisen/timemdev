...
$(document).ready(function(){
  ...
  var createNewTR = function (result, objectId){
      ...
      var td2 = $('<td id="timeInput"></td>').text(result.get("time"));
      // Start Button
      var td3 = '<input type="button" value="Start" id="countDown" class="remoteButtons" style="font-size: 16px; font-weight: 10px; background: white; width: 65px; border-radius: 4px; height: 30px; color: green;border: 2px solid white;-webkit-transition: .7s; position: relative; left: -10px;" onclick="hideInactiveAssignments(this)">';
      // Stop Button
      var td4 = '<input type="button" value="Stop" id="pause" class="remoteButtons" style="font-size: 16px; font-weight: 10px; background: white; width: 65px; border-radius: 4px; height: 30px; color: red;border: 2px solid white;-webkit-transition: .7s; position: relative; left: 10px;" onclick="showInactiveAssignments(this)" >';
      // Delete Button
      var td5 = '<input type="button" value="\u00D7" id="remove" class="remoteButtons" style="position: relative; left: -307%; top: 6px; background: transparent; border-color: transparent; color: white" onclick="deleteAssignment(this)">';
